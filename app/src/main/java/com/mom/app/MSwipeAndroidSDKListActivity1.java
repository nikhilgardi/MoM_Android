	...
	ArrayAdapter<String> adapter = new ArrayAdapter<String>(this,R.layout.row_layout, R.id.label , values);
			...
			listView.setOnItemClickListener(new OnItemClickListener() {
				...
				public void onItemClick(AdapterView<?> arg0, View arg1, int arg2,long arg3) 
				{
					if(arg2 == 0)
					{
						Intent intent =new Intent(MSwipeAndroidSDKListActivity1.this, LoginActivity.class);
...
//}
		...
		public void onBackPressed() {
			...
			myintenttest = new Intent(MSwipeAndroidSDKListActivity1.this, MainActivity.class);
