...
public class HomeBillActivity_PBX extends Activity implements OnClickListener {
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		myintent3 = new Intent(HomeBillActivity_PBX.this, LoginActivity.class);
		reintent = new Intent(HomeBillActivity_PBX.this, DashboardActivity.class);
			 ...
			 */
					...
					
				{
					...
					try {
						...
						nameValuePairs.add(new BasicNameValuePair("Mobile",myHelpez.GetMyRechargeMobileNumber()));
						...
						nameValuePairs.add(new BasicNameValuePair("Service", "UBP"));
						nameValuePairs.add(new BasicNameValuePair("SC", Get_OperatorID(myHelpez.GetMyRechargeOperator()).toString()));
						nameValuePairs.add(new BasicNameValuePair("SubNo", consumernumber.getText().toString()));
