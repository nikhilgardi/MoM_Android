...
public class PBXPLDataExImpl extends DataExImpl implements AsyncListener<TransactionRequest> {
    ...
    public void registerIMPSCustomer(TransactionRequest<ImpsCustomerRegistrationResult> request){
        if(request == null || TextUtils.isEmpty(request.getCustomerMobile())){
            if(_listener != null) {
        ...
        dataEx.execute(
            ...
            new BasicNameValuePair(AppConstants.PARAM_PBX_CONSUMER_NUMBER, request.getCustomerMobile()),
    ...
    public void getIMPSBeneficiaryList(TransactionRequest<List<BeneficiaryResult>> request){
        ...
        dataEx.execute(
           ...
           // new BasicNameValuePair(AppConstants.PARAM_PBX_ROWID,"true" ),
            new BasicNameValuePair(AppConstants.PARAM_PBX_RMN, request.getCustomerMobile())
        );
    }
    ...
    public TransactionRequest getIMPSBeneficiaryListResponse(TransactionRequest<List<BeneficiaryResult>> request){
        ...
        List<BeneficiaryResult> beneficiaryList    = Arrays.asList(responseBase.data);
