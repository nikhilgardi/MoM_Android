package com.mom.apps.model.b2cpl;
 ...
 */
public class B2CPLDataExImpl extends DataExImpl implements AsyncListener<TransactionRequest>{

    private String _LOG = AppConstants.LOG_PREFIX + "DATAEX_B2C";
    private static B2CPLDataExImpl _instance;
...
//                ),
    ...
    public void verifyTPin(String psTPin){
        ...
        dataEx.execute(
                ...
                new BasicNameValuePair(
                        AppConstants.PARAM_NEW_COMPANY_ID,
                        EphemeralStorage.getInstance(_applicationContext).getString(AppConstants.NEW_B2C_COMPANY_ID, null)
                ),
