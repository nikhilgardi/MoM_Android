...
public class TypeFaceManager {
     ...
     * apply a custom {@link com.mom.app.ui.ITextStyle} defined in the application theme.
     *
     * @param textView the {@link android.widget.TextView} to have the {@link com.mom.app.ui.ITextStyle} applied
    ...
    /**
     * Method called from code to apply a custom {@link com.mom.app.ui.ITextStyle}.
     *
     * @param textView  the {@link android.widget.TextView} to have the {@link com.mom.app.ui.ITextStyle} applied
     * @param textStyle the {@link com.mom.app.ui.ITextStyle} to be applied
     */
    ...
    /**
     * Apply a {@link android.graphics.Typeface} for a given {@link com.mom.app.ui.ITextStyle}.
     *
     * @param context   the {@link android.content.Context} of the {@link android.widget.TextView}
     * @param textStyle the {@link com.mom.app.ui.ITextStyle} to be applied
     * @return the {@link android.graphics.Typeface} corresponding to the {@link com.mom.app.ui.ITextStyle}, if defined
     */
    ...
    public Typeface getTypefaceForCurrentLocale(Context context){
        if(_currentTypeface != null){
            Log.d(_LOG, "Found typeface, returning: " + _currentTypeface.hashCode());
